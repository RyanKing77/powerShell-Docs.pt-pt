...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="617c9-102">Deteção de Script do PowerShell, instalação e gestão com o PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="617c9-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="617c9-103">Recurso de compartilhamento de Script do PowerShell foi adicionado ao PowerShellGet na versão do WMF 5.0 RTM.</span><span class="sxs-lookup"><span data-stu-id="617c9-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="617c9-104">Os seguintes cmdlets novos são adicionados ao módulo PowerShellGet para dar suporte a Scripts do PowerShell.</span><span class="sxs-lookup"><span data-stu-id="617c9-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="617c9-105">Sintaxe de script de Cmdlets de partilha:</span><span class="sxs-lookup"><span data-stu-id="617c9-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
