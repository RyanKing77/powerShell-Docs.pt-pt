...
---
# <a name="powershell-script-discovery-install-and-management-with-powershellget"></a><span data-ttu-id="fea5c-102">Deteção de Script do PowerShell, instalação e gestão com PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="fea5c-102">PowerShell Script Discovery, Install and Management with PowerShellGet</span></span>

<span data-ttu-id="fea5c-103">Partilha a funcionalidade de Script do PowerShell foi adicionado ao PowerShellGet a versão RTM do WMF 5.0.</span><span class="sxs-lookup"><span data-stu-id="fea5c-103">PowerShell Script sharing feature got added to the PowerShellGet in the WMF 5.0 RTM release.</span></span>
<span data-ttu-id="fea5c-104">Os seguintes novos cmdlets são adicionados ao módulo PowerShellGet para suportar os Scripts do PowerShell.</span><span class="sxs-lookup"><span data-stu-id="fea5c-104">The following new cmdlets are added to the PowerShellGet module for supporting the PowerShell Scripts.</span></span>
```powershell
...
<span data-ttu-id="fea5c-105">Sintaxe de script de Cmdlets de partilha:</span><span class="sxs-lookup"><span data-stu-id="fea5c-105">Syntax of script sharing Cmdlets:</span></span>
```powershell
