...
ms.locfileid: "34219237"
---
# <a name="information-stream"></a>Fluxo de Informações

Um novo fluxo de informações estruturado pode agora ser utilizado para transmitir dados estruturados entre um script e o respetivo anfitrião. **Anfitrião de escrita** também foi atualizado para emitir o resultado no fluxo de informações em que pode agora capturar ou silence-lo. A nova **escrita informações** cmdlet (juntamente com uma API WriteInformation correspondente) utilizada com **- InformationVariable** e **- InformationAction** parâmetros comuns permite a mais flexibilidade e a capacidade.
