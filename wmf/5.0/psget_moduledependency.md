...
---
# <a name="installation-of-module-dependencies"></a>Instalação de Dependências do Módulo
...
**Instale um módulo com dependências:**
```powershell
PS C:\windows\system32> Get-InstalledModule
...
**Ficheiro de manifesto de conteúdo do módulo de ModuleWithDependencies2:**
```powershell
@{
...
**Exemplos de módulo de atualização:**
```powershell
