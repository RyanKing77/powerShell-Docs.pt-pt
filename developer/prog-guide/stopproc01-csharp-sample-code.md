...
---
# <a name="stopproc01-c-sample-code"></a>StopProc01 (C#) Sample Code (Código de Exemplo StopProc01 [C#])

Aqui está o completa C# código para o cmdlet de exemplo StopProc01.
