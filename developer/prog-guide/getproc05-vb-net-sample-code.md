...
ms.locfileid: "62081687"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="b8c11-102">GetProc05 (VB.NET) Sample Code (Código de Exemplo GetProc05 [VB.NET])</span><span class="sxs-lookup"><span data-stu-id="b8c11-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="b8c11-103">Aqui está o código do VB.NET completo para o cmdlet de exemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="b8c11-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="b8c11-104">Veja Também</span><span class="sxs-lookup"><span data-stu-id="b8c11-104">See Also</span></span>

[<span data-ttu-id="b8c11-105">SDK do Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="b8c11-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)