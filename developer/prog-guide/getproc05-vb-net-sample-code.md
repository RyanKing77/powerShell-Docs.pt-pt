...
---
# <a name="getproc05-vbnet-sample-code"></a>GetProc05 (VB.NET) Sample Code (Código de Exemplo GetProc05 [VB.NET])

Aqui está o código do VB.NET completo para o cmdlet de exemplo GetProc05.
