...
ms.locfileid: "56845067"
---
# <a name="getproc05-vbnet-sample-code"></a><span data-ttu-id="86aef-102">GetProc05 (VB.NET) Sample Code (Código de Exemplo GetProc05 [VB.NET])</span><span class="sxs-lookup"><span data-stu-id="86aef-102">GetProc05 (VB.NET) Sample Code</span></span>

<span data-ttu-id="86aef-103">Aqui está o código do VB.NET completo para o cmdlet de exemplo GetProc05.</span><span class="sxs-lookup"><span data-stu-id="86aef-103">Here is the complete VB.NET code for the GetProc05 sample cmdlet.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="86aef-104">Veja Também</span><span class="sxs-lookup"><span data-stu-id="86aef-104">See Also</span></span>

[<span data-ttu-id="86aef-105">SDK do Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="86aef-105">Windows PowerShell SDK</span></span>](../windows-powershell-reference.md)