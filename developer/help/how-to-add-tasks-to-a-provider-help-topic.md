...
---
# <a name="how-to-add-tasks-to-a-provider-help-topic"></a>How to Add Tasks to a Provider Help Topic (Como Adicionar Tarefas ao Tópico de Ajuda de um Fornecedor)
