...
---
# <a name="scriptblock-element-for-expressionbinding-for-customcontrol-for-view-format"></a>ScriptBlock Element for ExpressionBinding for CustomControl for View (Format) (Elemento ScriptBlock para ExpressionBinding para CustomControl para View [Formatação])

Especifica o script cujo valor é apresentado pelo controle. Este elemento é utilizado ao definir uma vista de controle personalizado.
