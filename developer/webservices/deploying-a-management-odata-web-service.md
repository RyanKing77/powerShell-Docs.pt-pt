...
---
# <a name="deploying-a-management-odata-web-service"></a>Deploying a Management OData Web Service (Implementar um Serviço Web OData de Gestão)

Depois de concluir todas as etapas necessárias para criar um serviço da web de OData de gestão, tem de implementá-lo como uma aplicação web no IIS.

## <a name="deploying-the-web-service"></a>Implementar o serviço web

Conclua os seguintes passos para implementar o serviço da web de OData de gestão.

1. Criar um diretório para a sua aplicação de web sob o IIS `WWWRoot` diretório.

2. Copie o esquema ficheiro MOF, o arquivo do esquema XML, as DLLs que exportam a [Microsoft.Management.Odata.Customauthorization](/dotnet/api/Microsoft.Management.Odata.CustomAuthorization) e [System.Management.Automation.Remoting.Pssessionconfiguration](/dotnet/api/System.Management.Automation.Remoting.PSSessionConfiguration) interfaces e o ficheiro Web. config para o diretório de aplicação.

3. Criar um ID de site.

4. Criar e configurar um conjunto de aplicações.
...
Os scripts do Windows PowerShell seguintes demonstram como implementar um serviço da web de OData de gestão.
