...
---
# <a name="role-based-authorization-configuration-schema"></a>Role-Based Authorization Configuration Schema (Esquema de Configuração da Autorização Baseada em Funções)

O [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemplo usa arquivos XML para configurar a política de autorização. O XSD seguinte define o esquema utilizado para estes ficheiros.
