...
ms.locfileid: "56851409"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="46eb6-102">Role-Based Authorization Configuration Schema (Esquema de Configuração da Autorização Baseada em Funções)</span><span class="sxs-lookup"><span data-stu-id="46eb6-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="46eb6-103">O [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemplo usa arquivos XML para configurar a política de autorização.</span><span class="sxs-lookup"><span data-stu-id="46eb6-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="46eb6-104">O XSD seguinte define o esquema utilizado para estes ficheiros.</span><span class="sxs-lookup"><span data-stu-id="46eb6-104">The following XSD defines the schema used for these files.</span></span>
