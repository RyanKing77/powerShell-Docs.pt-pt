---
title: Esquema de configuração de autorização baseada em funções | Documentos da Microsoft
ms.custom: ''
ms.date: 09/12/2016
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62080548"
---
# <a name="role-based-authorization-configuration-schema"></a><span data-ttu-id="ec2d1-102">Role-Based Authorization Configuration Schema (Esquema de Configuração da Autorização Baseada em Funções)</span><span class="sxs-lookup"><span data-stu-id="ec2d1-102">Role-Based Authorization Configuration Schema</span></span>

<span data-ttu-id="ec2d1-103">O [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) exemplo usa arquivos XML para configurar a política de autorização.</span><span class="sxs-lookup"><span data-stu-id="ec2d1-103">The [PswsRoleBasedPlugins](http://go.microsoft.com/fwlink/?LinkId=243041) sample uses XML files to configure the authorization policy.</span></span> <span data-ttu-id="ec2d1-104">O XSD seguinte define o esquema utilizado para estes ficheiros.</span><span class="sxs-lookup"><span data-stu-id="ec2d1-104">The following XSD defines the schema used for these files.</span></span>
