...
---
# <a name="resource-mapping-schema"></a>Resource Mapping Schema (Esquema de Mapeamento de Recursos)

Extensão de gestão de IIS de OData usa arquivos XML para definir o mapeamento de recursos. O XSD seguinte define o esquema utilizado para estes ficheiros.

## <a name="resource-mapping-file-xsd"></a>Ficheiro de mapeamento de recursos XSD

O XSD seguinte define o esquema para arquivos de mapeamento de recursos de extensão de IIS de OData de gestão.
