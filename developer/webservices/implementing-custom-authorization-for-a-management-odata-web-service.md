...
O exemplo seguinte cria uma classe que analisa a política de autorização no arquivo XML.
...
```
 ...
 As seguintes classes representam grupos e utilizadores, respectivamente.
