...
---
# <a name="host06-sample"></a>Host06 Sample (Exemplo Host06)

Este exemplo mostra como criar um aplicativo de host e baseada em console interativo que lê os comandos da linha de comando, executa os comandos e, em seguida, apresenta os resultados no Console. Além disso, este exemplo utiliza as APIs de atomizador para especificar a cor do texto que é introduzido pelo utilizador.

## <a name="requirements"></a>Requisitos

- Este exemplo requer o Windows PowerShell 2.0.

- Esta aplicação tem de ser executada no modo elevado (executar como administrador).

## <a name="demonstrates"></a>Demonstra

- Criação de um host personalizado que derivam do [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe, o [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe e o [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe.

- Criar um aplicativo de console que usa essas classes de anfitrião para criar um shell interativo do Windows PowerShell.

- Criar um `$profile` variável e os seguintes perfis de carregamento.

  - utilizador atual, o anfitrião atual

  - utilizador atual, todos os anfitriões

  - todos os utilizadores, o anfitrião atual

  - todos os utilizadores, todos os anfitriões

- Implementar o [System.Management.Automation.Host.Ihostuisupportsmultiplechoiceselection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.

- Implementar o [System.Management.Automation.Host.Ihostsupportsinteractivesession](/dotnet/api/System.Management.Automation.Host.IHostSupportsInteractiveSession) interface para suportar a comunicação remota interativa de utilizando o [Enter-PsSession](/powershell/module/Microsoft.PowerShell.Core/Enter-PSSession) e [ Exit-PsSession](/powershell/module/Microsoft.PowerShell.Core/Exit-PSSession) cmdlets.

- Utilize a API de indexar para colorize da linha de comandos, como ele é digitado.

## <a name="example"></a>Exemplo

 Este exemplo permite ao utilizador introduzir os comandos na linha de comandos, processa esses comandos e, em seguida, imprime os resultados.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) classe que é utilizado por este aplicativo de host. Esses elementos que não são implementados lançam uma exceção ou retornam nada.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) classe que é utilizado por este aplicativo de host.
...
## <a name="example"></a>Exemplo
 ...
 O código a seguir é a implementação do [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) classe que é utilizado por este aplicativo de host. Esses elementos que não são implementados lançam uma exceção ou retornam nada.
...
## <a name="example"></a>Exemplo
 ...
 O código seguinte lê a linha de comandos e cores o texto como ele é inserido. Tokens são determinados com o [System.Management.Automation.Psparser.Tokenize*](/dotnet/api/System.Management.Automation.PSParser.Tokenize) método.
