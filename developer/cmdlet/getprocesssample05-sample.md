...
---
# <a name="getprocesssample05-sample"></a>GetProcessSample05 Sample (Exemplo GetProcessSample05)

Este exemplo mostra uma versão completa do cmdlet Get-Proc.

## <a name="how-to-build-the-sample-using-visual-studio"></a>Como criar o exemplo com o Visual Studio.

1. Abra o Explorador do Windows e navegue para o diretório de GetProcessSample05 sob o diretório de exemplos.

   Windows PowerShell 2.0 SDK instalado, navegue para a pasta de GetProcessSample05. A localização predefinida é C:\Program Files (x86) \Microsoft SDKs\Windows\v7.0\Samples\sysmgmt\WindowsPowerShell\csharp\GetProcessSample05.
...
3. Na **crie** menu, selecione **compilar solução**.
   ...
   A biblioteca para o exemplo será criada nos diretórios \bin ou \bin\debug padrão.
...
- Especificar as posições dos parâmetros.

- Especificando-se de que os parâmetros podem usar entrados do pipeline. A entrada pode ser realizada a partir de um objeto ou um valor de uma propriedade de um objeto cujo nome de propriedade é o mesmo que o nome do parâmetro.

- Declarar um atributo de validação para o parâmetro de entrada.

- O tratamento de erros e exceções.

- Mensagens de depuração de escrita.

## <a name="example"></a>Exemplo

Este exemplo mostra como criar um cmdlet que mostra uma lista de processos.
