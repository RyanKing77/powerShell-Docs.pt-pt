...
Verifique se o esquema de recursos (*. schema.mof) ficheiros. Pode utilizar o [Designer de recursos de DSC](https://www.powershellgallery.com/packages/xDSCResourceDesigner/1.12.0.0) para ajudar a desenvolver e testar o seu esquema.
...
Além disso, deve usar **teste xDscResource** e **teste xDscSchema** cmdlets da [Designer de recursos de DSC](https://www.powershellgallery.com/packages/xDSCResourceDesigner/1.12.0.0) para verificar automaticamente o recurso e o esquema:
...
- Daí: O maior problema com mensagens de erro é que, muitas vezes, não existem, por isso, certifique-se de que eles estão lá.
- Fácil de compreender: Códigos de erro de leitura e não obscuro humano
- Preciso: Descrever o que é exatamente o problema
- Construtivos: Conselhos sobre como resolver o problema
- Educado: Não o culparia usuário ou torná-los a se aflija
...
## <a name="best-practice-resource-module-contains-tests-folder-with-resourcedesignertestsps1-script"></a>Prática recomendada: Módulo de recursos contém a pasta de testes com ResourceDesignerTests.ps1 script
...
## <a name="best-practice-resource-folder-contains-resource-designer-script-for-generating-schema"></a>Prática recomendada: Pasta de recurso contém o script do estruturador de recurso para gerar esquema
...
## <a name="best-practice-resource-supports--whatif"></a>Prática recomendada: -WhatIf oferece suporte a recursos
