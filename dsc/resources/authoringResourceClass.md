...
O **$Path** e **$SourcePath** propriedades são ambas as cadeias de caracteres. O **$CreationTime** é um [DateTime](/dotnet/api/system.datetime) propriedade. O **$Ensure** propriedade é um tipo de enumeração, definido da seguinte forma.
