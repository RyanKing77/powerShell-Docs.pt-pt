...
> **Tenha em atenção**: O **ReportServerWeb** seção permite que os dados sejam enviados para o servidor de solicitação de relatórios.
...
>**Tenha em atenção**: Num cenário PUSH, um bug existe na versão atual que faz com que seja necessário definir uma propriedade de ConfigurationID no ficheiro metaconfiguration para nós que nunca tenha registado com um servidor de solicitação. Esta ação irá forçar o protocolo de servidor de solicitação do V1 e evitar mensagens de falha de registo.
