...
---
# <a name="setup-guide"></a>Guia de configuração

- [Instalar o PowerShell Core no macOS e Linux](Installing-PowerShell-Core-on-macOS-and-Linux.md)
- [Instalar o núcleo do PowerShell no Windows](Installing-PowerShell-Core-on-Windows.md)
- [Instalar o Windows PowerShell](Installing-Windows-PowerShell.md)
- [Instalar o Motor do Windows PowerShell 2.0](Installing-the-Windows-PowerShell-2.0-Engine.md)
- [Instalar o SKD do Windows PowerShell](Installing-the-Windows-PowerShell-SDK.md)
- [Referência da configuração](setup-reference.md)
