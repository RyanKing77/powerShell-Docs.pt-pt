...
---
# <a name="making-the-second-hop-in-powershell-remoting"></a>Efetuar segundo salto na comunicação remota do PowerShell
...
Para obter mais informações sobre as questões de segurança ao utilizar CredSSP para comunicação remota do PowerShell, consulte [Sabotage acidental: Tome cuidado com do CredSSP](https://www.powershellmagazine.com/2014/03/06/accidental-sabotage-beware-of-credssp).
...
Pode utilizar a delegação restrita herdada (não baseada em recursos) para que o segundo salto.
