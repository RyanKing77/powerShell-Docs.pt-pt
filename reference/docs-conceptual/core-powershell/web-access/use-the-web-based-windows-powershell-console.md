...
- Double-hop
    ...
    Para evitar erros de double-hop, o administrador deve configurar a autenticação CredSSP no seu ambiente de rede de organizações. Para obter mais informações sobre como configurar a autenticação CredSSP, consulte [CredSSP para comunicação remota do segundo salto](https://blogs.msdn.com/b/powershell/archive/2008/06/05/credssp-for-second-hop-remoting-part-i-domain-account.aspx) no site da Microsoft. Também pode fornecer credenciais explícitas quando pretender gerir um segundo computador remoto; é pouco provável que credenciais implícitas permitam o segundo hop.
