...
Prima **CRTL + H** ou, no **editar** menu, clique em **substituir no Script**. Introduza o texto que pretende localizar e o texto com o qual pretende substituí-lo e, em seguida, prima **ENTER**.
