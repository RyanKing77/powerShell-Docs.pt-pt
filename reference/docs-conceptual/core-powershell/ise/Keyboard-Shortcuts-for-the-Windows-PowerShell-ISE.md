...
---
# <a name="keyboard-shortcuts-for-the-windows-powershell-ise"></a>Atalhos de teclado para o ISE do Windows PowerShell
Utilize os seguintes atalhos de teclado para executar ações no Windows PowerShell® Integrated Scripting Environment (ISE). ISE do Windows PowerShell está disponível como parte do Windows Server e do cliente Windows operativo sistemas, mas podem também ser instalado em alguns sistemas de operativos mais antigos do Windows como parte do [pacote de transferência do Windows Management Framework 4.0](http://go.microsoft.com/fwlink/?LinkID=293881).
...
|----------|----------------------|----------|
|**Ajuda**|F1|Painel de script **importante:** pode especificar que o ajuda F1 for proveniente da Biblioteca TechNet na web ou transferido da ajuda (consulte a ajuda de atualização). Para selecionar, clique em **ferramentas**, **opções**, em seguida, no **definições gerais**separador, definir ou limpar **utilizar conteúdo de ajuda local em vez de conteúdo online.**|
|**Copiar**|CTRL + C|Painel, o painel de comando, o painel de resultados do script|
|**Cortar**|CTRL + X|Painel de script, o painel de comandos|
|**Expandir ou fechar definido que estipule o**|CTRL+M|Painel de script|
...
|**Localizar chaveta correspondente**|CTRL +]|Painel de script|
|**Colar**|CTRL + V|Painel de script, o painel de comandos|
|**Ação de Refazer**|CTRL + Y|Painel de script, o painel de comandos|
...
|**Mostrar fragmentos**|CTRL+J|Painel de script, o painel de comandos|
|**Anular**|CTRL + Z|Painel de script, o painel de comandos|
...
|**Separador** (para o script seguinte)|CTRL + TAB **Nota:** separador para o script seguinte funciona apenas quando tiver um separador único do Windows PowerShell, abrir, ou quando tem mais do que um separador de Windows PowerShell abrir, mas centra-se no painel de Script.|
|**Separador** (para o script anterior)|CTRL + SHIFT + TAB **Nota:** separador ao script anterior funciona quando tem apenas uma abertura de separador do Windows PowerShell ou se tiver mais do que um separador de Windows PowerShell abrir e centra-se no painel de Script.|
...
|Ação|Atalho de teclado|
|----------|---------------------|
|**Aceda ao comando (v2) ou a consola (v3 e posterior) painel**|CTRL + D|
...
> [!NOTE]
> Também pode utilizar os atalhos de teclado concebidos para a consola do Windows PowerShell quando depurar scripts no ISE do Windows PowerShell. Para utilizar estes atalhos, tem de escrever o atalho no painel de comandos e prima ENTER.
...
|**Separador anterior do PowerShell**|CTRL + SHIFT + TAB. Este atalho funciona apenas quando não existem ficheiros abertos em qualquer separador do Windows PowerShell.|
|**Separador que se segue do Windows PowerShell**|CTRL + TAB. Este atalho funciona apenas quando não existem ficheiros abertos em qualquer separador do Windows PowerShell.|
...
- [PowerShell Magazine: A lista completa de atalhos de teclado do Windows PowerShell ISE](http://www.powershellmagazine.com/2013/01/29/the-complete-list-of-powershell-ise-3-0-keyboard-shortcuts/)
