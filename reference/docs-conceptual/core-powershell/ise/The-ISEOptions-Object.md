...
---
# <a name="the-iseoptions-object"></a>O objeto de ISEOptions
...
### <a name="selectedscriptpanestate"></a>SelectedScriptPaneState
 ...
 A propriedade de leitura/escrita que obtém ou define a posição do painel de Script no ecrã do. A cadeia pode ser "Maximizado", "Top" ou "Direito".
