...
---
# <a name="collecting-information-about-computers"></a>Recolher informações sobre computadores
...
Para filtrar os metadados, utilize um operador de pipeline (|) para enviar os resultados do comando Get-WmiObject para **Select-Object - propriedade [a-z]***.
