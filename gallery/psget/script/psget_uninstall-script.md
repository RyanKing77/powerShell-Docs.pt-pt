...
---
# <a name="uninstall-script"></a><span data-ttu-id="55521-103">Script de desinstalação</span><span class="sxs-lookup"><span data-stu-id="55521-103">Uninstall-Script</span></span>

<span data-ttu-id="55521-104">Desinstala um ficheiro de script que foi instalado através de PowerShellGet.</span><span class="sxs-lookup"><span data-stu-id="55521-104">Uninstalls a script file which was installed using PowerShellGet.</span></span>

## <a name="description"></a><span data-ttu-id="55521-105">Descrição</span><span class="sxs-lookup"><span data-stu-id="55521-105">Description</span></span>

<span data-ttu-id="55521-106">O cmdlet de Script de desinstalação desinstala os ficheiros de script especificado instalado do repositório online.</span><span class="sxs-lookup"><span data-stu-id="55521-106">The Uninstall-Script cmdlet uninstalls the specified script files which were installed from the online repository.</span></span>

## <a name="cmdlet-syntax"></a><span data-ttu-id="55521-107">Sintaxe de cmdlet</span><span class="sxs-lookup"><span data-stu-id="55521-107">Cmdlet syntax</span></span>

```powershell
Get-Command -Name Uninstall-Script -Module PowerShellGet -Syntax
```
## <a name="cmdlet-online-help-reference"></a><span data-ttu-id="55521-108">Referência de ajuda online do cmdlet</span><span class="sxs-lookup"><span data-stu-id="55521-108">Cmdlet online help reference</span></span>

[<span data-ttu-id="55521-109">Script de desinstalação</span><span class="sxs-lookup"><span data-stu-id="55521-109">Uninstall-Script</span></span>](http://go.microsoft.com/fwlink/?LinkId=619789)

## <a name="example-commands"></a><span data-ttu-id="55521-110">Comandos de exemplo</span><span class="sxs-lookup"><span data-stu-id="55521-110">Example commands</span></span>
