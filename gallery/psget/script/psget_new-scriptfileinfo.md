...
---
# <a name="new-scriptfileinfo"></a>Novo ScriptFileInfo

Cria um ficheiro de script com metadados.

## <a name="description"></a>Descrição

O cmdlet New-ScriptFileInfo cria um ficheiro de script do PowerShell, incluindo os metadados sobre o script.
...
[Novo ScriptFileInfo](http://go.microsoft.com/fwlink/?LinkId=619792)
...
### <a name="new-scriptfileinfo-cmdlet"></a>Cmdlet de novo ScriptFileInfo
Novo ScriptFileInfo cmdlet permite-lhe criar um novo ficheiro de script com metadados como versão, Guid, autor e a descrição, etc. 
