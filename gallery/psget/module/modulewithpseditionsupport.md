...
## <a name="powershell-gallery-users-can-find-the-list-of-modules-supported-on-a-specific-powershell-edition-using-tags-pseditiondesktop-and-pseditoncore"></a>Utilizadores de galeria do PowerShell podem encontrar a lista de módulos suportado uma edição específica do PowerShell, utilizando etiquetas PSEdition_Desktop e PSEditon_Core.
Módulos sem PSEdition_Desktop e PSEditon_Core etiquetas são considerados para ajustar funcionam nas edições de ambiente de trabalho do PowerShell.
...
### <a name="scripts-with-pseditionsscriptscriptwithpseditionsupportmd"></a>[Scripts com PSEditions](../script/scriptwithpseditionsupport.md)
...
### <a name="update-module-manifest-psgetupdate-modulemanifestmd"></a>[Manifesto de módulo de atualização] (./psget_update-modulemanifest.md)
